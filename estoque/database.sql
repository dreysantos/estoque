...
DROP TABLE IF EXISTS entrada_equipamentos;
...
DROP VIEW IF EXISTS view_entrada_equipamentos;
DROP VIEW IF EXISTS view_saidas;
DROP VIEW IF EXISTS view_saida_equipamentos;
DROP VIEW IF EXISTS view_solicitacoes;
DROP VIEW IF EXISTS view_solicitacao_equipamentos;
